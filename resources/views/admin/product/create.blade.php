                    ...
                    <div class="card-body">
                        ...
                        <form class="form-horizontal" action="{{ route('product.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-9">
                                    <select multiple name="color[]" class="form-control js-select2 w-100" data-placeholder="Choose one" multiple>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-9">
                                    <select multiple name="size[]" class="form-control js-select2 w-100" data-placeholder="Choose one" multiple>
                                        <option label="Choose one"></option>

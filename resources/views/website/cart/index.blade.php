                        ...
                        <div class="tp-cart-list mb-25 mr-30">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td class="tp-cart-img"><a href="product-details.html"> <img src="{{asset($product->options->image)}}" alt=""></a></td>
                                       ...
                                       <span class="tp-cart-minus">
                                          <svg width="10" height="2" viewBox="0 0 10 2" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <form action="{{route('cart.update',$product->rowId)}}" method="post">
                                                @csrf
                                                @method('PUT')
                                                <input class="tp-cart-input form-control" type="text" value="{{$product->qty}}" name="qty">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="tp-cart-checkout-wrapper">
                            ...
                            <div class="tp-cart-checkout-total d-flex align-items-center justify-content-between">
                                <span>Total</span>
                                <span>{{  $grandTotal = $sum + $tax + $shipping }}</span>
                            </div>

                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-5 col-lg-6">
                            ...
                            <div class="tp-product-details-wrapper">
                                ...
                                <p class="category">Product Category <i class="fa-light fa-tag"></i>{{ $product->category->name }}</p>
                                <p class="category">Product Sub Category <i class="fa-light fa-tag"></i>{{ $product->subCategory->name }}</p>
                                <p class="category">Product Brand <i class="fa-light fa-tag"></i>{{ $product->brand->name }}</p>
                                <p class="category">Product Selling Unit <i class="fa-light fa-tag"></i>{{ $product->unit->name }}</p>
                                    ...
                                    <div class="tp-product-details-action-item-wrapper d-flex align-items-center">
                                       ...
                                       <span class="tp-cart-minus">
                                        ...
                                        <div class="tp-product-details-add-to-cart mb-15 w-100">
                                            <button class="tp-product-details-add-to-cart-btn w-100 btn" type="submit">Add To Cart</button>
                                        </div>
                                    </div>

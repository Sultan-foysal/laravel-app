                    ...
                    <div class="col-xl-6 col-lg-8">
                        <div class="tp-login-wrapper">
                            <div class="tp-login-option">
                                <form class="row" method="post" action="{{route('customer.login')}}">
                                    @csrf
                                    ...
                                    <span id="open-eye" class="open-close">
                                    ...
                                    <div class="tp-login-bottom">
                                        <button href="#" class="tp-login-btn w-100" type="submit">Login</button>
                                    </div>
                                    <p class="outer-link">Don't have an account?  <a href="{{ route('customer.register') }}">Login Now</a></p>
                                </form>
                            </div>
                        </div>
                    </div>

                        ...
                        <div class="tp-login-wrapper">
                            <div class="tp-login-option">
                                ...
                                <div class="tp-login-input-wrapper">
                                    <div class="tp-login-input-box">
                                        <div class="tp-login-input">
                                            <input id="name" type="text" placeholder="Your Full Name" name="name">
                                        </div>
                                    ...
                                    <div class="tp-login-input-box">
                                        <div class="tp-login-input">
                                            <input id="email" type="number" placeholder="Your Phone Number" name="mobile">
                                        </div>
                                        <div class="tp-login-input-title">
                                ...
                                <div class="tp-login-bottom">
                                    <button href="#" class="tp-login-btn w-100" type="submit">Sign Up</button>
                                </div>
                                    <p class="outer-link">Already have an account? <a href="{{ route('customer.login') }}">Login Now</a></p>
                                </form>
                            </div>
                        </div>
                    </div>
